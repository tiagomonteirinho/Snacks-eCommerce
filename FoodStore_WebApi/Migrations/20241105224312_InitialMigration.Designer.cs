...
namespace SnackseCommerce_API.Migrations
{
    ...
    [Migration("20241105224312_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FoodStore_WebApi.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodStore_WebApi.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodStore_WebApi.Entities.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodStore_WebApi.Entities.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodStore_WebApi.Entities.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodStore_WebApi.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FoodStore_WebApi.Entities.Order", b =>
                {
                    b.HasOne("FoodStore_WebApi.Entities.User", null)
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("FoodStore_WebApi.Entities.OrderDetail", b =>
                {
                    b.HasOne("FoodStore_WebApi.Entities.Order", "Order")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FoodStore_WebApi.Entities.Product", "Product")
                        .WithMany("OrderDetails")
            ...
            modelBuilder.Entity("FoodStore_WebApi.Entities.Product", b =>
                {
                    b.HasOne("FoodStore_WebApi.Entities.Category", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("FoodStore_WebApi.Entities.ShoppingCartItem", b =>
                {
                    b.HasOne("FoodStore_WebApi.Entities.Product", null)
